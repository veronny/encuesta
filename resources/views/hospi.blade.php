        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning" role="alert">
                            En primer lugar, califique las expectativas, que se refieren a la IMPORTANCIA que usted le otorga a la atención que espera recibir en el servicio de Hospitalización  (Nivel I-4, II y III). Utilice una escala numérica del 1 al 7.Considere 1 como la menor calificación y 7 como la mayor calificación.
                        </div>
            ...
            <div class="col-lg-6 mb-4 ">
                ...
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                            En segundo lugar, califique las percepciones que se refieren a como usted HA RECIBIDO, la atención en el servicio de Hospitalización (Nivel  I-4, II y III). Utilice una escala numérica del 1 al 7.Considere 1 como la menor calificación y 7 como la mayor calificación.
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                <thead class="border-bottom">
